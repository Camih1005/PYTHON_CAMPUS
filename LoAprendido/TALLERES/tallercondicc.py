def eliminarDicc(dicEmpleados):
    leerIDEmpl()
    buscarEmpleado(dicEmpleados, leerIDEmpl)
    del dicEmpleados[buscarEmpleado]
...
def mnubuscarEmpleado(dicEmpleados):
    ...
    print(f"Salario: ${dicEmpleados[idEmpl]['Salario']:,}")
